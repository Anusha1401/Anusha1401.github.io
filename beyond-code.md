    ...
    <div class="timeline-body">
      ...
      <div class="passions-grid">
        <div class="passion-card">
          ...
          <h3>Travelling</h3>
          <p>Exploring new cultures, tasting local food, and collecting memories from around the world.</p>
        </div>
        <div class="passion-card">
          <span class="passion-icon">🍳</span>
          <h3>Cooking</h3>
          <p>From traditional Indian recipes to experimenting with cuisines from every corner of the globe.</p>
        </div>
        <div class="passion-card">
          <span class="passion-icon">🎨</span>
          <h3>Drawing</h3>
