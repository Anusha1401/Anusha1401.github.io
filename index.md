...
- **4.5 years** working in **India**, working in a service-based company.  
- **2.5 years** working in the **United Kingdom**, working in a product companies, developing secure, cloud-native and AI-driven platforms  
- **Currently based in California, USA**, and actively seeking new opportunities  

I enjoy working across the full development lifecycle (SDLC)—from backend architecture and API design to frontend development, deployment, and long-term maintenance. I’m especially motivated by building systems that are reliable, maintainable, and genuinely useful.
...
**Code Vulnerability Scanning & Security Tools**  
- SonarQube
- Invicti (Kondukto)
- Brakeman
...
- Worked with a team, building **AI-powered meeting assistant** that generated summaries and action items using Ruby on Rails and LLM integration  
...
- Delivered complex, web applications end-to-end  
...
**LinkedIn:** https://www.linkedin.com/in/anusha-shetty-5755561a7/  
